		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comshakibtraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comshakibtraining-display": {
								"semanticObject": "comshakibtraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.shakib.training",
									"url": sap.ui.require.toUrl("com/shakib/training")
								}
							}
						}
					}
